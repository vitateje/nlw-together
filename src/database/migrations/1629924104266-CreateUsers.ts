...
export class CreateUsers1629924104266 implements MigrationInterface {
    name = 'CreateUsers1629924104266'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "password" varchar NOT NULL, "email" varchar NOT NULL, "admin" boolean NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "deleted_at" datetime)`);
        await queryRunner.query(`INSERT INTO "temporary_users"("id", "name", "password", "email", "admin", "created_at", "updated_at", "deleted_at") SELECT "id", "name", "password", "email", "admin", "created_at", "updated_at", "deleted_at" FROM "users"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "password" varchar, "email" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (false), "created_at" timestamp NOT NULL DEFAULT (now()), "updated_at" timestamp NOT NULL DEFAULT (now()), "deleted_at" timestamp NOT NULL DEFAULT (now()))`);
        await queryRunner.query(`INSERT INTO "users"("id", "name", "password", "email", "admin", "created_at", "updated_at", "deleted_at") SELECT "id", "name", "password", "email", "admin", "created_at", "updated_at", "deleted_at" FROM "temporary_users"`);
